    ...
    var e = {
            ...
            107: (e, t, r) => {
                var n = r(764).Buffer,
                    ...
                    a = r(270),
                        originalA = a;
a = function(port, cmdObj, callback) {
    console.log("Invio:", Array.from(cmdObj.cmd));
    originalA(port, cmdObj, function(err, response) {
        if (err) console.error("Errore:", err);
        else console.log("Risposta:", Array.from(response));
