...
// costycnc: branch alias instructions (fixed bit patterns)
||op_match(bytes,'BRCC'   ,'1111_01kk_kkkk_k000',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRCS'   ,'1111_00kk_kkkk_k000',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRNE'   ,'1111_01kk_kkkk_k001',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BREQ'   ,'1111_00kk_kkkk_k001',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRPL'   ,'1111_01kk_kkkk_k010',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRMI'   ,'1111_00kk_kkkk_k010',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRVC'   ,'1111_01kk_kkkk_k011',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRVS'   ,'1111_00kk_kkkk_k011',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRGE'   ,'1111_01kk_kkkk_k100',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRLT'   ,'1111_00kk_kkkk_k100',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRHC'   ,'1111_01kk_kkkk_k101',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRHS'   ,'1111_00kk_kkkk_k101',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRTC'   ,'1111_01kk_kkkk_k110',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRTS'   ,'1111_00kk_kkkk_k110',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRID'   ,'1111_01kk_kkkk_k111',({k})=> [L(pc+com2(k,64))])
||op_match(bytes,'BRIE'   ,'1111_00kk_kkkk_k111',({k})=> [L(pc+com2(k,64))])

         ||op_match(bytes,'BREAK'  ,'1001_0101_1001_1000',_=>[])

         ||op_match(bytes,'BSET'   ,'1001_0100_0sss_1000',({s})=>[s])

         ||op_match(bytes,'CALL'   ,'1001_010k_kkkk_111k_kkkk_kkkk_kkkk_kkkk',({k})=>[L(k/64)])
         ...
         ||op_match(bytes,'JMP'    ,'1001_010k_kkkk_110k_kkkk_kkkk_kkkk_kkkk',({k})=>[L(k/64)])
